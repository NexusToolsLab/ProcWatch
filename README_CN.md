...
- ✨ 新增自动刷新设置与刷新间隔弹窗
- 💾 常用配置持久化（刷新间隔、开关、过滤阈值、排序）
- 🧭 新增“了解 ProcWatch”信息弹窗与外部链接
